...
**Q: 如何配置 ESP32 硬件？**
- 查看 [ESP32 硬件设置教程](https://github.com/DegenStar/RuView/issues/34)

---

## 📚 更多信息

- **ESP32 硬件设置**: [教程 #34](https://github.com/DegenStar/RuView/issues/34)
- **Windows WiFi 使用**: [教程 #36](https://github.com/DegenStar/RuView/issues/36)
- **完整文档**: 查看 `README_EN.md` 获取详细技术文档、架构图和 API 参考
- **遇到问题？** 在 [GitHub Issues](https://github.com/DegenStar/RuView/issues) 搜索或提问
...
- [GitHub Issues](https://github.com/DegenStar/RuView/issues)
- [Discussions](https://github.com/DegenStar/RuView/discussions)
